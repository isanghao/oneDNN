...
#define C(tag, ... /* perm, inner_blks, inner_idxs */) \
    ...
    switch (tag) {
        ...
        C(ABc4b8a4b, {0, 1, 2}, {4, 8, 4}, {1, 0, 1});
        C(AcB4b8a4b, {0, 2, 1}, {4, 8, 4}, {1, 0, 1});
        C(ABc4b16a4b, {0, 1, 2}, {4, 16, 4}, {1, 0, 1});
        C(AcB4b16a4b, {0, 2, 1}, {4, 16, 4}, {1, 0, 1});
        C(ABc4b24a4b, {0, 1, 2}, {4, 24, 4}, {1, 0, 1});
        C(AcB4b24a4b, {0, 2, 1}, {4, 24, 4}, {1, 0, 1});
        C(ABc4b32a4b, {0, 1, 2}, {4, 32, 4}, {1, 0, 1});
        C(AcB4b32a4b, {0, 2, 1}, {4, 32, 4}, {1, 0, 1});
        C(ABc4b64a4b, {0, 1, 2}, {4, 64, 4}, {1, 0, 1});
        C(AcB4b64a4b, {0, 2, 1}, {4, 64, 4}, {1, 0, 1});
        ...
        C(AcB16b16a, {0, 2, 1}, {16, 16}, {1, 0});
        C(ABc16b32a, {0, 1, 2}, {16, 32}, {1, 0});
        C(AcB16b32a, {0, 2, 1}, {16, 32}, {1, 0});
        C(ABc16b48a, {0, 1, 2}, {16, 48}, {1, 0});
        C(AcB16b48a, {0, 2, 1}, {16, 48}, {1, 0});
        C(ABc16b64a, {0, 1, 2}, {16, 64}, {1, 0});
        C(AcB16b64a, {0, 2, 1}, {16, 64}, {1, 0});
        ...
        C(AcB8b16a2b, {0, 2, 1}, {8, 16, 2}, {1, 0, 1});
        C(ABc8b32a2b, {0, 1, 2}, {8, 32, 2}, {1, 0, 1});
        C(AcB8b32a2b, {0, 2, 1}, {8, 32, 2}, {1, 0, 1});
        C(ABc8b64a2b, {0, 1, 2}, {8, 64, 2}, {1, 0, 1});
        C(AcB8b64a2b, {0, 2, 1}, {8, 64, 2}, {1, 0, 1});
        C(ABc8b8a, {0, 1, 2}, {8, 8}, {1, 0});
        C(AcB8b8a, {0, 2, 1}, {8, 8}, {1, 0});
        ...
        C(AcdB16b16a, {0, 2, 3, 1}, {16, 16}, {1, 0});
        C(ABcd16b32a, {0, 1, 2, 3}, {16, 32}, {1, 0});
        C(AcdB16b32a, {0, 2, 3, 1}, {16, 32}, {1, 0});
        C(ABcd16b48a, {0, 1, 2, 3}, {16, 48}, {1, 0});
        C(AcdB16b48a, {0, 2, 3, 1}, {16, 48}, {1, 0});
        C(ABcd16b64a, {0, 1, 2, 3}, {16, 64}, {1, 0});
        C(AcdB16b64a, {0, 2, 3, 1}, {16, 64}, {1, 0});
        C(aBCd16b16c, {0, 1, 2, 3}, {16, 16}, {1, 2});
        C(aBCd16c16b, {0, 1, 2, 3}, {16, 16}, {2, 1});
        C(ABcd4b8a4b, {0, 1, 2, 3}, {4, 8, 4}, {1, 0, 1});
        C(AcdB4b8a4b, {0, 2, 3, 1}, {4, 8, 4}, {1, 0, 1});
        C(ABcd4b16a4b, {0, 1, 2, 3}, {4, 16, 4}, {1, 0, 1});
        C(AcdB4b16a4b, {0, 2, 3, 1}, {4, 16, 4}, {1, 0, 1});
        C(ABcd4b24a4b, {0, 1, 2, 3}, {4, 24, 4}, {1, 0, 1});
        C(AcdB4b24a4b, {0, 2, 3, 1}, {4, 24, 4}, {1, 0, 1});
        C(ABcd4b32a4b, {0, 1, 2, 3}, {4, 32, 4}, {1, 0, 1});
        C(AcdB4b32a4b, {0, 2, 3, 1}, {4, 32, 4}, {1, 0, 1});
        C(ABcd4b64a4b, {0, 1, 2, 3}, {4, 64, 4}, {1, 0, 1});
        C(AcdB4b64a4b, {0, 2, 3, 1}, {4, 64, 4}, {1, 0, 1});
        ...
        C(AcdeB16b16a, {0, 2, 3, 4, 1}, {16, 16}, {1, 0});
        C(ABcde16b32a, {0, 1, 2, 3, 4}, {16, 32}, {1, 0});
        C(AcdeB16b32a, {0, 2, 3, 4, 1}, {16, 32}, {1, 0});
        C(ABcde16b48a, {0, 1, 2, 3, 4}, {16, 48}, {1, 0});
        C(AcdeB16b48a, {0, 2, 3, 4, 1}, {16, 48}, {1, 0});
        C(ABcde16b64a, {0, 1, 2, 3, 4}, {16, 64}, {1, 0});
        C(AcdeB16b64a, {0, 2, 3, 4, 1}, {16, 64}, {1, 0});
        ...
        C(AcdeB8b16a2b, {0, 2, 3, 4, 1}, {8, 16, 2}, {1, 0, 1});
        C(ABcde8b32a2b, {0, 1, 2, 3, 4}, {8, 32, 2}, {1, 0, 1});
        C(AcdeB8b32a2b, {0, 2, 3, 4, 1}, {8, 32, 2}, {1, 0, 1});
        C(ABcde8b64a2b, {0, 1, 2, 3, 4}, {8, 64, 2}, {1, 0, 1});
        C(AcdeB8b64a2b, {0, 2, 3, 4, 1}, {8, 64, 2}, {1, 0, 1});
        C(BAcde8a16b2a, {1, 0, 2, 3, 4}, {8, 16, 2}, {0, 1, 0});
        C(ABcde4b8a4b, {0, 1, 2, 3, 4}, {4, 8, 4}, {1, 0, 1});
        C(AcdeB4b8a4b, {0, 2, 3, 4, 1}, {4, 8, 4}, {1, 0, 1});
        C(ABcde4b16a4b, {0, 1, 2, 3, 4}, {4, 16, 4}, {1, 0, 1});
        C(AcdeB4b16a4b, {0, 2, 3, 4, 1}, {4, 16, 4}, {1, 0, 1});
        C(ABcde4b24a4b, {0, 1, 2, 3, 4}, {4, 24, 4}, {1, 0, 1});
        C(AcdeB4b24a4b, {0, 2, 3, 4, 1}, {4, 24, 4}, {1, 0, 1});
        C(ABcde4b32a4b, {0, 1, 2, 3, 4}, {4, 32, 4}, {1, 0, 1});
        C(AcdeB4b32a4b, {0, 2, 3, 4, 1}, {4, 32, 4}, {1, 0, 1});
        C(ABcde4b64a4b, {0, 1, 2, 3, 4}, {4, 64, 4}, {1, 0, 1});
        C(AcdeB4b64a4b, {0, 2, 3, 4, 1}, {4, 64, 4}, {1, 0, 1});
        ...
        C(aBdC8b2c, {0, 1, 3, 2}, {8, 2}, {1, 2});
        C(aBdC8b4c, {0, 1, 3, 2}, {8, 4}, {1, 2});
        C(aBdec16b, {0, 1, 3, 4, 2}, {16}, {1});
        C(aBdeC16b2c, {0, 1, 3, 4, 2}, {16, 2}, {1, 2});
        C(aBdeC16b4c, {0, 1, 3, 4, 2}, {16, 4}, {1, 2});
        C(aBdec8b, {0, 1, 3, 4, 2}, {8}, {1});
        C(aBdeC8b2c, {0, 1, 3, 4, 2}, {8, 2}, {1, 2});
        C(aBdeC8b4c, {0, 1, 3, 4, 2}, {8, 4}, {1, 2});
        ...
        C(aBdefC8b2c, {0, 1, 3, 4, 5, 2}, {8, 2}, {1, 2});
        C(aBdefC8b4c, {0, 1, 3, 4, 5, 2}, {8, 4}, {1, 2});
        ...
        C(abCdef4c, {0, 1, 2, 3, 4, 5}, {4}, {2});
        C(abCd32c, {0, 1, 2, 3}, {32}, {2});
        C(abCde32c, {0, 1, 2, 3, 4}, {32}, {2});
        ...
        C(abdEC64e4c, {0, 1, 3, 4, 2}, {64, 4}, {4, 2});
        C(abdCe16c, {0, 1, 3, 2, 4}, {16}, {2});
        C(abdCe32c, {0, 1, 3, 2, 4}, {32}, {2});
        C(abdCE32c2e, {0, 1, 3, 2, 4}, {32, 2}, {2, 4});
        C(ABc16a4b, {0, 1, 2}, {16, 4}, {0, 1});
        C(ABcd16a4b, {0, 1, 2, 3}, {16, 4}, {0, 1});
        C(ABcde16a4b, {0, 1, 2, 3, 4}, {16, 4}, {0, 1});
        ...
        C(aCdefB16b32c2b, {0, 2, 3, 4, 5, 1}, {16, 32, 2}, {1, 2, 1});
        C(aCdefB16b32c4b, {0, 2, 3, 4, 5, 1}, {16, 32, 4}, {1, 2, 1});
        C(aCdefB16b48c2b, {0, 2, 3, 4, 5, 1}, {16, 48, 2}, {1, 2, 1});
        C(aCdefB16b48c4b, {0, 2, 3, 4, 5, 1}, {16, 48, 4}, {1, 2, 1});
        C(aCdefB16b64c2b, {0, 2, 3, 4, 5, 1}, {16, 64, 2}, {1, 2, 1});
        C(aCdefB16b64c4b, {0, 2, 3, 4, 5, 1}, {16, 64, 4}, {1, 2, 1});
        C(BcdeA16a32b2a, {1, 2, 3, 4, 0}, {16, 32, 2}, {0, 1, 0});
        C(BcdeA16a32b4a, {1, 2, 3, 4, 0}, {16, 32, 4}, {0, 1, 0});
        C(BcdeA16a48b2a, {1, 2, 3, 4, 0}, {16, 48, 2}, {0, 1, 0});
        C(BcdeA16a48b4a, {1, 2, 3, 4, 0}, {16, 48, 4}, {0, 1, 0});
        C(BcdeA16a64b2a, {1, 2, 3, 4, 0}, {16, 64, 2}, {0, 1, 0});
        C(BcdeA16a64b4a, {1, 2, 3, 4, 0}, {16, 64, 4}, {0, 1, 0});
        C(aCdefb32c, {0, 2, 3, 4, 5, 1}, {32}, {2});
        C(aCdefB32c2b, {0, 2, 3, 4, 5, 1}, {32, 2}, {2, 1});
        C(aCdefB32c4b, {0, 2, 3, 4, 5, 1}, {32, 4}, {2, 1});
        C(aCdefb48c, {0, 2, 3, 4, 5, 1}, {48}, {2});
        C(aCdefB48c2b, {0, 2, 3, 4, 5, 1}, {48, 2}, {2, 1});
        C(aCdefB48c4b, {0, 2, 3, 4, 5, 1}, {48, 4}, {2, 1});
        C(aCdefb64c, {0, 2, 3, 4, 5, 1}, {64}, {2});
        C(aCdefB64c2b, {0, 2, 3, 4, 5, 1}, {64, 2}, {2, 1});
        C(aCdefB64c4b, {0, 2, 3, 4, 5, 1}, {64, 4}, {2, 1});
        C(Bcdea32b, {1, 2, 3, 4, 0}, {32}, {1});
        C(BcdeA32b2a, {1, 2, 3, 4, 0}, {32, 2}, {1, 0});
        C(BcdeA32b4a, {1, 2, 3, 4, 0}, {32, 4}, {1, 0});
        C(Bcdea48b, {1, 2, 3, 4, 0}, {48}, {1});
        C(BcdeA48b2a, {1, 2, 3, 4, 0}, {48, 2}, {1, 0});
        C(BcdeA48b4a, {1, 2, 3, 4, 0}, {48, 4}, {1, 0});
        C(Bcdea64b, {1, 2, 3, 4, 0}, {64}, {1});
        C(BcdeA64b2a, {1, 2, 3, 4, 0}, {64, 2}, {1, 0});
        C(BcdeA64b4a, {1, 2, 3, 4, 0}, {64, 4}, {1, 0});
        C(Bca32b, {1, 2, 0}, {32}, {1});
        C(BcA32b2a, {1, 2, 0}, {32, 2}, {1, 0});
        C(BcA32b4a, {1, 2, 0}, {32, 4}, {1, 0});
        C(Bca48b, {1, 2, 0}, {48}, {1});
        C(BcA48b2a, {1, 2, 0}, {48, 2}, {1, 0});
        C(BcA48b4a, {1, 2, 0}, {48, 4}, {1, 0});
        C(Bca64b, {1, 2, 0}, {64}, {1});
        C(BcA64b2a, {1, 2, 0}, {64, 2}, {1, 0});
        C(BcA64b4a, {1, 2, 0}, {64, 4}, {1, 0});
        C(aCdb32c, {0, 2, 3, 1}, {32}, {2});
        C(aCdB32c2b, {0, 2, 3, 1}, {32, 2}, {2, 1});
        C(aCdB32c4b, {0, 2, 3, 1}, {32, 4}, {2, 1});
        C(aCdb48c, {0, 2, 3, 1}, {48}, {2});
        C(aCdB48c2b, {0, 2, 3, 1}, {48, 2}, {2, 1});
        C(aCdB48c4b, {0, 2, 3, 1}, {48, 4}, {2, 1});
        C(aCdb64c, {0, 2, 3, 1}, {64}, {2});
        C(aCdB64c2b, {0, 2, 3, 1}, {64, 2}, {2, 1});
        C(aCdB64c4b, {0, 2, 3, 1}, {64, 4}, {2, 1});
        C(BcA16a16b2a, {1, 2, 0}, {16, 16, 2}, {0, 1, 0});
        C(BcA16a16b4a, {1, 2, 0}, {16, 16, 4}, {0, 1, 0});
        C(BcdA16a16b2a, {1, 2, 3, 0}, {16, 16, 2}, {0, 1, 0});
        C(BcdA16a16b4a, {1, 2, 3, 0}, {16, 16, 4}, {0, 1, 0});
        C(BcdeA16a16b2a, {1, 2, 3, 4, 0}, {16, 16, 2}, {0, 1, 0});
        C(BcdeA16a16b4a, {1, 2, 3, 4, 0}, {16, 16, 4}, {0, 1, 0});
        C(aCdB16b16c2b, {0, 2, 3, 1}, {16, 16, 2}, {1, 2, 1});
        C(aCdB16b16c4b, {0, 2, 3, 1}, {16, 16, 4}, {1, 2, 1});
        C(aCdeB16b16c2b, {0, 2, 3, 4, 1}, {16, 16, 2}, {1, 2, 1});
        C(aCdeB16b16c4b, {0, 2, 3, 4, 1}, {16, 16, 4}, {1, 2, 1});
        C(aCdefB16b16c2b, {0, 2, 3, 4, 5, 1}, {16, 16, 2}, {1, 2, 1});
        C(aCdefB16b16c4b, {0, 2, 3, 4, 5, 1}, {16, 16, 4}, {1, 2, 1});
        C(BcA16a32b2a, {1, 2, 0}, {16, 32, 2}, {0, 1, 0});
        C(BcA16a32b4a, {1, 2, 0}, {16, 32, 4}, {0, 1, 0});
        C(BcA16a48b2a, {1, 2, 0}, {16, 48, 2}, {0, 1, 0});
        C(BcA16a48b4a, {1, 2, 0}, {16, 48, 4}, {0, 1, 0});
        C(BcA16a64b2a, {1, 2, 0}, {16, 64, 2}, {0, 1, 0});
        C(BcA16a64b4a, {1, 2, 0}, {16, 64, 4}, {0, 1, 0});
        C(aCdB16b32c2b, {0, 2, 3, 1}, {16, 32, 2}, {1, 2, 1});
        C(aCdB16b32c4b, {0, 2, 3, 1}, {16, 32, 4}, {1, 2, 1});
        C(aCdB16b48c2b, {0, 2, 3, 1}, {16, 48, 2}, {1, 2, 1});
        C(aCdB16b48c4b, {0, 2, 3, 1}, {16, 48, 4}, {1, 2, 1});
        C(aCdB16b64c2b, {0, 2, 3, 1}, {16, 64, 2}, {1, 2, 1});
        C(aCdB16b64c4b, {0, 2, 3, 1}, {16, 64, 4}, {1, 2, 1});
        C(BcdA16a32b2a, {1, 2, 3, 0}, {16, 32, 2}, {0, 1, 0});
        C(BcdA16a32b4a, {1, 2, 3, 0}, {16, 32, 4}, {0, 1, 0});
        C(BcdA16a48b2a, {1, 2, 3, 0}, {16, 48, 2}, {0, 1, 0});
        C(BcdA16a48b4a, {1, 2, 3, 0}, {16, 48, 4}, {0, 1, 0});
        C(BcdA16a64b2a, {1, 2, 3, 0}, {16, 64, 2}, {0, 1, 0});
        C(BcdA16a64b4a, {1, 2, 3, 0}, {16, 64, 4}, {0, 1, 0});
        C(aCdeB16b32c2b, {0, 2, 3, 4, 1}, {16, 32, 2}, {1, 2, 1});
        C(aCdeB16b32c4b, {0, 2, 3, 4, 1}, {16, 32, 4}, {1, 2, 1});
        C(aCdeB16b48c2b, {0, 2, 3, 4, 1}, {16, 48, 2}, {1, 2, 1});
        C(aCdeB16b48c4b, {0, 2, 3, 4, 1}, {16, 48, 4}, {1, 2, 1});
        C(aCdeB16b64c2b, {0, 2, 3, 4, 1}, {16, 64, 2}, {1, 2, 1});
        C(aCdeB16b64c4b, {0, 2, 3, 4, 1}, {16, 64, 4}, {1, 2, 1});
        C(Bca8b, {1, 2, 0}, {8}, {1});
        C(BcA8b2a, {1, 2, 0}, {8, 2}, {1, 0});
        C(BcA8b4a, {1, 2, 0}, {8, 4}, {1, 0});
        C(Bcda8b, {1, 2, 3, 0}, {8}, {1});
        C(BcdA8b2a, {1, 2, 3, 0}, {8, 2}, {1, 0});
        C(BcdA8b4a, {1, 2, 3, 0}, {8, 4}, {1, 0});
        C(Bcdea8b, {1, 2, 3, 4, 0}, {8}, {1});
        C(BcdeA8b2a, {1, 2, 3, 4, 0}, {8, 2}, {1, 0});
        C(BcdeA8b4a, {1, 2, 3, 4, 0}, {8, 4}, {1, 0});
        C(aCdb8c, {0, 2, 3, 1}, {8}, {2});
        C(aCdB8c2b, {0, 2, 3, 1}, {8, 2}, {2, 1});
        C(aCdB8c4b, {0, 2, 3, 1}, {8, 4}, {2, 1});
        C(aCdeb8c, {0, 2, 3, 4, 1}, {8}, {2});
        C(aCdeB8c2b, {0, 2, 3, 4, 1}, {8, 2}, {2, 1});
        C(aCdeB8c4b, {0, 2, 3, 4, 1}, {8, 4}, {2, 1});
        C(aCdefb8c, {0, 2, 3, 4, 5, 1}, {8}, {2});
        C(aCdefB8c2b, {0, 2, 3, 4, 5, 1}, {8, 2}, {2, 1});
        C(aCdefB8c4b, {0, 2, 3, 4, 5, 1}, {8, 4}, {2, 1});
        C(Bca16b, {1, 2, 0}, {16}, {1});
        C(BcA16b2a, {1, 2, 0}, {16, 2}, {1, 0});
        C(BcA16b4a, {1, 2, 0}, {16, 4}, {1, 0});
        C(Bcda16b, {1, 2, 3, 0}, {16}, {1});
        C(BcdA16b2a, {1, 2, 3, 0}, {16, 2}, {1, 0});
        C(BcdA16b4a, {1, 2, 3, 0}, {16, 4}, {1, 0});
        C(Bcdea16b, {1, 2, 3, 4, 0}, {16}, {1});
        C(BcdeA16b2a, {1, 2, 3, 4, 0}, {16, 2}, {1, 0});
        C(BcdeA16b4a, {1, 2, 3, 4, 0}, {16, 4}, {1, 0});
        C(aCdb16c, {0, 2, 3, 1}, {16}, {2});
        C(aCdB16c2b, {0, 2, 3, 1}, {16, 2}, {2, 1});
        C(aCdB16c4b, {0, 2, 3, 1}, {16, 4}, {2, 1});
        C(aCdeb16c, {0, 2, 3, 4, 1}, {16}, {2});
        C(aCdeB16c2b, {0, 2, 3, 4, 1}, {16, 2}, {2, 1});
        C(aCdeB16c4b, {0, 2, 3, 4, 1}, {16, 4}, {2, 1});
        C(aCdefb16c, {0, 2, 3, 4, 5, 1}, {16}, {2});
        C(aCdefB16c2b, {0, 2, 3, 4, 5, 1}, {16, 2}, {2, 1});
        C(aCdefB16c4b, {0, 2, 3, 4, 5, 1}, {16, 4}, {2, 1});
        C(Bca24b, {1, 2, 0}, {24}, {1});
        C(BcA24b2a, {1, 2, 0}, {24, 2}, {1, 0});
        C(BcA24b4a, {1, 2, 0}, {24, 4}, {1, 0});
        C(Bcda24b, {1, 2, 3, 0}, {24}, {1});
        C(BcdA24b2a, {1, 2, 3, 0}, {24, 2}, {1, 0});
        C(BcdA24b4a, {1, 2, 3, 0}, {24, 4}, {1, 0});
        C(Bcdea24b, {1, 2, 3, 4, 0}, {24}, {1});
        C(BcdeA24b2a, {1, 2, 3, 4, 0}, {24, 2}, {1, 0});
        C(BcdeA24b4a, {1, 2, 3, 4, 0}, {24, 4}, {1, 0});
        C(aCdb24c, {0, 2, 3, 1}, {24}, {2});
        C(aCdB24c2b, {0, 2, 3, 1}, {24, 2}, {2, 1});
        C(aCdB24c4b, {0, 2, 3, 1}, {24, 4}, {2, 1});
        C(aCdeb24c, {0, 2, 3, 4, 1}, {24}, {2});
        C(aCdeB24c2b, {0, 2, 3, 4, 1}, {24, 2}, {2, 1});
        C(aCdeB24c4b, {0, 2, 3, 4, 1}, {24, 4}, {2, 1});
        C(aCdefb24c, {0, 2, 3, 4, 5, 1}, {24}, {2});
        C(aCdefB24c2b, {0, 2, 3, 4, 5, 1}, {24, 2}, {2, 1});
        C(aCdefB24c4b, {0, 2, 3, 4, 5, 1}, {24, 4}, {2, 1});
        C(Bcda32b, {1, 2, 3, 0}, {32}, {1});
        C(BcdA32b2a, {1, 2, 3, 0}, {32, 2}, {1, 0});
        C(BcdA32b4a, {1, 2, 3, 0}, {32, 4}, {1, 0});
        C(Bcda48b, {1, 2, 3, 0}, {48}, {1});
        C(BcdA48b2a, {1, 2, 3, 0}, {48, 2}, {1, 0});
        C(BcdA48b4a, {1, 2, 3, 0}, {48, 4}, {1, 0});
        C(Bcda64b, {1, 2, 3, 0}, {64}, {1});
        C(BcdA64b2a, {1, 2, 3, 0}, {64, 2}, {1, 0});
        C(BcdA64b4a, {1, 2, 3, 0}, {64, 4}, {1, 0});
        C(aCdeb32c, {0, 2, 3, 4, 1}, {32}, {2});
        C(aCdeB32c2b, {0, 2, 3, 4, 1}, {32, 2}, {2, 1});
        C(aCdeB32c4b, {0, 2, 3, 4, 1}, {32, 4}, {2, 1});
        C(aCdeb48c, {0, 2, 3, 4, 1}, {48}, {2});
        C(aCdeB48c2b, {0, 2, 3, 4, 1}, {48, 2}, {2, 1});
        C(aCdeB48c4b, {0, 2, 3, 4, 1}, {48, 4}, {2, 1});
        C(aCdeb64c, {0, 2, 3, 4, 1}, {64}, {2});
        ...
        C(AcB24a2b, {0, 2, 1}, {24, 2}, {0, 1});
        C(AcdB24a2b, {0, 2, 3, 1}, {24, 2}, {0, 1});
        C(AcdeB24a2b, {0, 2, 3, 4, 1}, {24, 2}, {0, 1});
        C(aBdC24b2c, {0, 1, 3, 2}, {24, 2}, {1, 2});
        C(aBdeC24b2c, {0, 1, 3, 4, 2}, {24, 2}, {1, 2});
        C(aBdefC24b2c, {0, 1, 3, 4, 5, 2}, {24, 2}, {1, 2});
        C(AcB24a4b, {0, 2, 1}, {24, 4}, {0, 1});
        C(AcdB24a4b, {0, 2, 3, 1}, {24, 4}, {0, 1});
        C(AcdeB24a4b, {0, 2, 3, 4, 1}, {24, 4}, {0, 1});
        C(aBdC24b4c, {0, 1, 3, 2}, {24, 4}, {1, 2});
        C(aBdeC24b4c, {0, 1, 3, 4, 2}, {24, 4}, {1, 2});
        C(aBdefC24b4c, {0, 1, 3, 4, 5, 2}, {24, 4}, {1, 2});

        C(AB8b32a, {0, 1}, {8, 32}, {1, 0});
        C(ABc8b32a, {0, 1, 2}, {8, 32}, {1, 0});
        C(AcB8b32a, {0, 2, 1}, {8, 32}, {1, 0});
        C(ABcd8b32a, {0, 1, 2, 3}, {8, 32}, {1, 0});
        C(AcdB8b32a, {0, 2, 3, 1}, {8, 32}, {1, 0});
        C(ABcde8b32a, {0, 1, 2, 3, 4}, {8, 32}, {1, 0});
        C(AcdeB8b32a, {0, 2, 3, 4, 1}, {8, 32}, {1, 0});
        C(AB8b24a, {0, 1}, {8, 24}, {1, 0});
        C(ABc8b24a, {0, 1, 2}, {8, 24}, {1, 0});
        C(AcB8b24a, {0, 2, 1}, {8, 24}, {1, 0});
        C(ABcd8b24a, {0, 1, 2, 3}, {8, 24}, {1, 0});
        C(AcdB8b24a, {0, 2, 3, 1}, {8, 24}, {1, 0});
        C(ABcde8b24a, {0, 1, 2, 3, 4}, {8, 24}, {1, 0});
        C(AcdeB8b24a, {0, 2, 3, 4, 1}, {8, 24}, {1, 0});
        C(AB8b16a, {0, 1}, {8, 16}, {1, 0});
        C(ABc8b16a, {0, 1, 2}, {8, 16}, {1, 0});
        C(AcB8b16a, {0, 2, 1}, {8, 16}, {1, 0});
        C(ABcd8b16a, {0, 1, 2, 3}, {8, 16}, {1, 0});
        C(AcdB8b16a, {0, 2, 3, 1}, {8, 16}, {1, 0});
        C(ABcde8b16a, {0, 1, 2, 3, 4}, {8, 16}, {1, 0});
        C(AcdeB8b16a, {0, 2, 3, 4, 1}, {8, 16}, {1, 0});
        C(AB8b8a, {0, 1}, {8, 8}, {1, 0});

        C(AB8b24a2b, {0, 1}, {8, 24, 2}, {1, 0, 1});
        C(ABc8b24a2b, {0, 1, 2}, {8, 24, 2}, {1, 0, 1});
        C(AcB8b24a2b, {0, 2, 1}, {8, 24, 2}, {1, 0, 1});
        C(ABcd8b24a2b, {0, 1, 2, 3}, {8, 24, 2}, {1, 0, 1});
        C(AcdB8b24a2b, {0, 2, 3, 1}, {8, 24, 2}, {1, 0, 1});
        C(ABcde8b24a2b, {0, 1, 2, 3, 4}, {8, 24, 2}, {1, 0, 1});
        C(AcdeB8b24a2b, {0, 2, 3, 4, 1}, {8, 24, 2}, {1, 0, 1});
        C(AB8b8a2b, {0, 1}, {8, 8, 2}, {1, 0, 1});
        C(ABc8b8a2b, {0, 1, 2}, {8, 8, 2}, {1, 0, 1});
        C(AcB8b8a2b, {0, 2, 1}, {8, 8, 2}, {1, 0, 1});
